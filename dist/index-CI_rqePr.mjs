    ...
    transformed = applyTransformersSync(
      ...
      [
        (_filePath, _code) => {
          ...
          let result;
          try {
            result = transformSync$1(_code, esbuildOptions);
          } catch (error) {
    ...
    transformed = await applyTransformers(
      ...
      [
        async (_filePath, _code) => {
          ...
          let result;
          try {
            result = await transform$1(_code, esbuildOptions);
          } catch (error) {
            throw formatEsbuildError(error);
          }
          return patchResult(result);
...
export { transformSync as a, transformDynamicImport as b, isESM as i, readJsonFile as r, transform as t };
